...
const projects: Project[] = [
...

  {
    id: uuid(),
    title: 'Kulture-API',
    description: 'A role-based access control system for admin and customer accounts.',
    github: 'https://github.com/Olatisunkanmi/Kulture-api',
    live: '',
    stack: 'Laravel + PHP + SQL + Docker + Eloquent ORM + Redis',
    isPrivate: false,
    isLive: false,
  },
  {
    id: uuid(),
    title: 'CrowdFundME-API',
    description: 'A simple fintech API for a multi-currency crowdfunding platform using Node.js and MySQL.',
    github: 'https://github.com/Olatisunkanmi/CrowdFund-Me',
    live: '',
    stack: 'Expressjs + Nodejs + SQL',
    isPrivate: false,
    isLive: false,
  },
